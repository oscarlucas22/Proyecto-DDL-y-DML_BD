create table HOSPITAL (
    ...
    constraint NH_1 check(Nombre_Hospital ~ '^[A-Z]{0,1}[a-z]'),
...
create table HABITACION (
    ...
    constraint NH_3 check(Nombre_Hospital ~ '^[A-Z]{0,1}[a-z]'),
...
create table EMPLEADO (
    ...
    constraint NH_5 check(Nombre_Hospital ~ '^[A-Z]{0,1}[a-z]'),
...
create table ENFERMO (
    ...
    constraint NH_6 check(Nombre_Hospital ~ '^[A-Z]{0,1}[a-z]'),
