...
create table EMPLEADO (
    Codigo_Empleado varchar(9) unique,
    Nombre_Hospital varchar(10),
    Funcion varchar(10) default('Enfermero'),
    Turno varchar(1),
    Salario int(4),
    constraint PK_3 primary key (Codigo_Empleado, Nombre_Hospital),
    constraint COD_E_fk check(Codigo_Empleado regexp binary '^[0-9][0-9][0-9]\-[A-Z]'),
...
create table ENFERMO (
    ...
    constraint FI_1 check (month(Fecha_Ingreso) != '06' and month(Fecha_Ingreso) != '07' and month(Fecha_Ingreso) != '08'),
...
--2--
alter table ENFERMO add column Fecha_Nacimiento date;
...
--8-- 
--//No se puede desactivar en MySQL por lo tanto borro la restriccion//--
